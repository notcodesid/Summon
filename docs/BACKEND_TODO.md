...
- [ ] **B01 — Anchor workspace and configuration**
...
- [ ] **B03 — Fair rarity and item selection**
...
- [ ] **B04 — MagicBlock VRF request/callback**
...
- [ ] **B05 — Ephemeral Rollup lifecycle**
...
- [ ] **B06 — Program errors, events, and observability**
...
- [ ] **B12 — Full verification**
  ...
  - Acceptance: all local checks pass, secrets remain ignored, and deployment is the
    only approval-gated step left.
